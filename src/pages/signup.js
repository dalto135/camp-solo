            ...
            <div className="pink">
                ...
                <form>
                    <div>
                        ...
                        className="input-field" type="email" name='firstName' 
                        // class="form-control" 
                        id="username-input" aria-describedby="emailHelp" placeholder="First Name"/>
                    </div>
                    ...
                    <div>
                        ...
                        <input 
                        // onChange={handleInputChange} 
                        className="input-field" type="email" name='lastName' 
                        // class="form-control" 
                        id="username-input" aria-describedby="emailHelp" placeholder="Last Name"/>
                    </div>
                    ...
                    <div>
                        ...
                        <input 
                        // onChange={handleInputChange} 
                        className="input-field" type="email" name='username' 
                        // class="form-control" 
                        id="username-input" aria-describedby="emailHelp" placeholder="New username"/>
                    </div>
                    ...
                    <div>
                        ...
                        // class="form-control" 
                        id="password-input" aria-describedby="emailHelp" placeholder="New password"/>
                    </div>
                    ...
                    <div>
                        ...
                        // class="form-control" 
                        id="email-input" aria-describedby="emailHelp" placeholder="Input email for signup"/>
                    </div>
